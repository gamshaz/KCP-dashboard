...
4. d_before = days in front month before meeting, d_after = days after, d_total = total days
5. expected_change = back implied rate - front implied rate
6. P(cut 25bp) = expected_change / 0.25 clamped to [0,1]
7. P(hold) = 1 - P(cut)

Known limitation: single-cut-or-hold model only. Multi-outcome (50bp) extension is Phase 2.
